  ...
  useEffect(() => {
    const works: any = [
      ...
      },
      {
        ...
        client: "Mambo's Chicken",
        url: "https://mamboschicken.com",
      },
      {
        title: "African Forum on Debt",
      ...
      },
      {
        ...
        client: "Impala Car Rental",
        url: "https://impala.co.zw",
      },
      {
        title: "Panel Beating Site",
        thumbnail: "/assets/images/gk.png",
        client: "Golden Knot Panel Beaters",
